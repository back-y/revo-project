	...
	?>
		...
		<div id="contents" <?php revo_content_product(); ?> role="main">
			<div class="content_list_product">
				...
				?>
					<ul id="loop-products" class="products-loop row clearfix grid-view grid" data-postids="<?php echo ( $product_sku ) ? implode( ',', $post_ids ) : ''; ?>" data-attributes="<?php echo revo_product_attribute(); ?>" data-maxpage="<?php echo esc_attr( $product_query->max_num_pages ); ?>">
					<?php 
						...
						<div class="pagination nav-pag pull-right">
							<?php if( $product_sku ) { ?>
								...
								<ul class="page-numbers sw-ajax-pagination">	
									<li><a href="#" class="prev disabled"> <?php echo esc_html__( 'Prev', 'revo' ); ?></a></li>
									...
									<?php } ?>	
									<li><a href="#" class="next"><?php echo esc_html__( 'Next', 'revo' ); ?></a></li>
								</ul>
								<?php }else{ ?>
								<div class="sw-ajax-pagination">
									<span class="page-title"><?php esc_html_e( 'Page', 'revo' ); ?>:</span>
